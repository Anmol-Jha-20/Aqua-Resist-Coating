!(function (e) {
  ...
  if (
    ...
    e(document).on("DOMContentLoaded", function () {
      ...
      e(document).on("mousemove", function (t) {
        var a = t.pageX,
          n = t.pageY;
        e(".custom-element").stop().animate({ left: a, top: n }, 300);
      });
    }),
    e(".th-anim").length)
  ) {
  ...
  const w = document.querySelector(".slider-drag-cursor"),
    C = { x: window.innerWidth / 2, y: window.innerHeight / 2 },
    k = { x: C.x, y: C.y },
  ...
  window.addEventListener("pointermove", (e) => {
    ...
    e(document).on("DOMContentLoaded", function () {
      e(".choose-progress-bar .progress-fill .counter").each(function () {
        var t = e(this).html();
        parseInt(t);
        e(this).parent().css({ height: t }).animate({ height: t }, 1e3);
      });
      var t = 0,
        a = 0;
      e(".choose-progress-bar .progress-fill .counter").each(function () {
            ...
            e(".radial-progress").each(function (t, a) {
              ...
              if (i > s && n < o) {
                ...
                e(this)
                  ...
                  .animate({ "stroke-dashoffset": d }, 2800);
              }
            });
        }
      }
